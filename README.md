...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/zenoh-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/zenoh-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libzenohcxx
# for installing globally
pixi global install libzenohcxx
```
...
It is possible to list all of the versions of `libzenohcxx` available on your platform:
...
```
pixi search libzenohcxx --channel conda-forge
```
